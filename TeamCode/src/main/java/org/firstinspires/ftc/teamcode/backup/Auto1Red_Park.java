...
@Autonomous(name = "back_up_Auto1Red_Park.java", group = "")
public class Auto1Red_Park extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    */
    ...
    backRightWheel.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    //FEB12
    backRightWheel.setTargetPosition(700); //211
    backLeftWheel.setTargetPosition(700);
    backRightWheel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    backLeftWheel.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    frontRightWheel.setPower(0.3); //0.2
